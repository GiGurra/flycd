...
func Deploy(ctx context.Context, path string, force bool) error {
	...
	if hasAppYaml {
		...
		err2 := DeploySingleAppFromFolder(ctx, path, force)
		if err2 != nil {
